...
entity MicroProgV3 is
    Port ( OPCODE       : in std_ulogic_vector(7 downto 0);
           ...
           PE           : out std_ulogic);
end entity MicroProgV3;

architecture MicroProgV3Behavior of MicroProgV3 is
...
begin
     ...
     begin
         ...
         case OPCODE is
             ...
             when x"20"  => S <=  "0000"; IMUX <= '1'; OMUX <= '0'; ACCUEN <= '1'; WE <= '-'; OE <= '0'; PE <= '0';-- jmp
             when x"22"  => S <=  "0000"; IMUX <= '1'; OMUX <= '0'; ACCUEN <= '1'; WE <= '-'; OE <= '0'; PE <= '0';-- jz
             when x"23"  => S <=  "0000"; IMUX <= '1'; OMUX <= '0'; ACCUEN <= '1'; WE <= '-'; OE <= '0'; PE <= '0';-- jnz
             when x"24"  => S <=  "0000"; IMUX <= '1'; OMUX <= '0'; ACCUEN <= '1'; WE <= '-'; OE <= '0'; PE <= '0';-- js
             when x"25"  => S <=  "0000"; IMUX <= '1'; OMUX <= '0'; ACCUEN <= '1'; WE <= '-'; OE <= '0'; PE <= '0';-- jns
...
end architecture MicroProgV3Behavior;
