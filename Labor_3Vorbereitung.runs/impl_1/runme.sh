...
HD_PWD='E:/Labor_3Vorbereitung_fertig/Labor_3Vorbereitung.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MINIuP_T7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MINIuP_T7.tcl -notrace
