...
begin
    ...
    TransOutNet : process (S, OPCODE, ZERO, SIGN)
    begin
        IPCLK <= '0';
        IRCLK <= '0';
        ACCLK <= '0';
        ...
        if ( ( OPCODE = x"20" ) or
             ( OPCODE = x"22" and ZERO='1' ) or
             ( OPCODE = x"23" and ZERO='0' ) or
             ( OPCODE = x"24" and SIGN='1') or
             ( OPCODE = x"25" and SIGN='0' ) ) then
             IPLOADN <= '0';
        else IPLOADN <= '1';
        end if;
        ...
        case S is
            ...
            when S1 => IRCLK <= '1'; STATEIND <= "01";
                       ...
                       case OPCODE is
                           when x"00"  => Splus <= S3; RE <= '0';
                           when x"41"  => Splus <= S2; RE <= '1';
                           when x"42"  => Splus <= S2; RE <= '1';
                           when x"44"  => Splus <= S2; RE <= '1';
